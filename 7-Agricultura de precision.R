...
Datos_ENPA$`Tecnologías producción` = case_when(Datos_ENPA$`Tecnologías producción`==1 ~ "Nada",
                                                Datos_ENPA$`Tecnologías producción`==2 ~ "Siembra y fertilización variable",
                                                T ~ "Todo")
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$Estilo_cognitivo)

Datos_ENPA %>%
  mutate(Estilo_cognitivo=as.factor(Estilo_cognitivo)) %>% 
  count(`Tecnologías producción`, Estilo_cognitivo) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=Estilo_cognitivo) +
  geom_bar(stat="identity") +
  scale_fill_manual(values=c("#61D04F","#F5C710","#2297E6"),name="Estilo cognitivo\ndel productor")+
  ylab("Porcentaje") +
  xlab("Clusters Agricultura de precisión")+
  geom_text(aes(label=paste(round(pct, 1),"%")),
            position=position_stack(vjust=0.5)) +
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$Edad)

Datos_ENPA %>%
  mutate(Edad=as.factor(Edad)) %>% 
  count(`Tecnologías producción`, Edad) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=Edad) +
  geom_bar(stat="identity") +
  scale_fill_manual(values=c("#61D04F","#2297E6","#F5C710","#DF536B","#CD0BBC"),name="Edad del productor")+
  ylab("Porcentaje") +
  xlab("Clusters Tecnologías de producción")+
  geom_text(aes(label=paste(round(pct, 1),"%")),
            position=position_stack(vjust=0.5)) +
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$Tamaño)

Datos_ENPA %>%
  mutate(Tamaño=as.factor(Tamaño)) %>% 
  count(`Tecnologías producción`, Tamaño) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=Tamaño) +
  geom_bar(stat="identity") +
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$Provincia)

Datos_ENPA %>%
  mutate(Provincia=as.factor(Provincia)) %>% 
  count(`Tecnologías producción`, Provincia) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=Provincia) +
  geom_bar(stat="identity") +
...
Datos_ENPA %>%
  ...
  count(`Tecnologías producción`, ProvReg) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=ProvReg) +
  geom_bar(stat="identity") +
  #scale_fill_manual(values=c("#61D04F","#2297E6","#F5C710","#DF536B"),name="Provincia del productor")+
  ylab("Porcentaje") +
  xlab("Clusters Tecnologías de producción")+
...
table(Datos_ENPA$P9,Datos_ENPA$`Tecnologías producción`)
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$Tierra)

Datos_ENPA %>%
  mutate(Tierra=as.factor(Tierra)) %>% 
  count(`Tecnologías producción`, Tierra) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=Tierra) +
  geom_bar(stat="identity") +
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$P31)

Datos_ENPA %>%
  mutate(P31=as.factor(P31)) %>% 
  count(`Tecnologías producción`, P31) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=P31) +
  geom_bar(stat="identity") +
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$P32)

Datos_ENPA %>%
  mutate(P32=as.factor(P32)) %>% 
  count(`Tecnologías producción`, P32) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=P32) +
  geom_bar(stat="identity") +
  scale_fill_manual(values=c("#DF536B","#61D04F"),name="Planificación\ninversiones")+
  ylab("Porcentaje") +
  xlab("Clusters Tecnologías de producción")+
...
write.xlsx(tabla, "D:/Otros/Austral/tablas/P23 Prod.xlsx",overwrite = F)
# P35
...
write.xlsx(tabla, "D:/Otros/Austral/tablas/P35 grupos Prod.xlsx",overwrite = F)
...
write.xlsx(tabla2, "D:/Otros/Austral/tablas/P35 Prod.xlsx",overwrite = F)
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$P25b_1)

Datos_ENPA %>%
  mutate(P25b_1=as.factor(P25b_1)) %>% 
  count(`Tecnologías producción`, P25b_1) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=P25b_1) +
  geom_bar(stat="identity") +
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$P25b_3)

Datos_ENPA %>%
  mutate(P25b_3=as.factor(P25b_3)) %>% 
  count(`Tecnologías producción`, P25b_3) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=P25b_3) +
  geom_bar(stat="identity") +
  scale_fill_manual(values=c("#DF536B","#61D04F"),name="Lo realiza")+
  ylab("Porcentaje") +
  xlab("Clusters Tecnologías de producción")+
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$P25b_5)

Datos_ENPA %>%
  mutate(P25b_5=as.factor(P25b_5)) %>% 
  count(`Tecnologías producción`, P25b_5) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=P25b_5) +
  geom_bar(stat="identity") +
  scale_fill_manual(values=c("#DF536B","#61D04F"),name="Lo realiza")+
  ylab("Porcentaje") +
  xlab("Clusters Tecnologías de producción")+
...
chisq.test(Datos_ENPA$`Tecnologías producción`,Datos_ENPA$P25b_6)

Datos_ENPA %>%
  mutate(P25b_6=as.factor(P25b_6)) %>% 
  count(`Tecnologías producción`, P25b_6) %>%       
  group_by(`Tecnologías producción`) %>%
  mutate(pct= prop.table(n) * 100) %>% 
  ggplot() + aes(`Tecnologías producción`, pct, fill=P25b_6) +
  geom_bar(stat="identity") +
  scale_fill_manual(values=c("#DF536B","#61D04F"),name="Lo realiza")+
  ylab("Porcentaje") +
  xlab("Clusters Tecnologías de producción")+
